...
const defaultItems = [
  {
    ...
    link: '#',
    title: 'John Carter',
    description: 'NexaExchange made investing so easy and transparent. I feel confident about my financial future!'
  },
  {
    image: img44,
    link: '#',
  ...
  },
  {
    ...
    link: '#',
    title: 'Sophia Turner',
    description: 'Joining NexaExchange was the best decision for my investments. The returns are fantastic!'
  },
  {
    image: img23,
    link: '#',
    ...
    <div className="relative w-full h-full">
      ...
      {activeItem && (
        <>
          ...
          absolute
          font-black
          [font-size:4rem] left-[1.6em] top-1/2 translate-x-[20%] -translate-y-1/2
          transition-all ease-[cubic-bezier(0.25,0.1,0.25,1.0)]
          sm:[font-size:2.2rem] sm:left-[0.5em] sm:translate-x-0 sm:max-w-[70vw] sm:pr-2
          ${
            isMoving
        ...
        `}
          ...
          select-none
          absolute
          max-w-[10ch] text-[1.5rem] top-1/2 right-[1%]
          transition-all ease-[cubic-bezier(0.25,0.1,0.25,1.0)]
          sm:max-w-[16ch] sm:text-[1rem] sm:right-[0.5em] sm:top-[60%] sm:translate-x-0 sm:-translate-y-1/2
          ${
            isMoving
        ...
        `}
          >
            {activeItem.description.length > 60 ? `${activeItem.description.slice(0, 60)}...` : activeItem.description}
          </p>
