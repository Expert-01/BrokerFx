...
export default function Footer() {
  ...
  <div className="text-lg font-bold text-yellow-400 font-orbitron">NexaExchange</div>
  <div className="text-sm font-orbitron">&copy; {new Date().getFullYear()} NexaExchange. All rights reserved.</div>
