  ...
  return (
    <section className="border border-[#181a20] text-white p-6 sm:p-8 rounded-2xl shadow-2xl mb-8 w-full max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
        <div className="flex flex-col items-center bg-black border border-[#181a20] rounded-xl p-3 sm:p-4 shadow-lg w-full">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
        <div className="flex flex-col items-center bg-[#181a20] rounded-xl p-3 sm:p-4 shadow-lg w-full">
      ...
      <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center sm:justify-end w-full">
        <button
          className="glass-radial-btn px-4 sm:px-6 py-2 rounded-xl font-bold relative w-full sm:w-auto"
          onClick={() => setDepositOpen(true)}
        >
          <span className="relative z-10">Deposit</span>
          <span className="absolute inset-0 bg-white opacity-10 rounded-xl pointer-events-none"></span>
        </button>
        <button className="glass-radial-btn px-4 sm:px-6 py-2 rounded-xl font-bold w-full sm:w-auto">
...
export default AccountOverview;        <div className="flex flex-col items-center bg-black border border-[#181a20] rounded-xl p-4 shadow-lg">
          <span className="text-xs text-gray-400 mb-1 ">Platform</span>
          <span className="text-lg font-bold text-yellow-400">
            MT5
          </span>
      ...
      <div className="flex md:flex-row gap-2 md:gap-4 justify-center md:justify-end w-1/2 md:w-full flex-row"  >
        <button className="glass-radial-btn md:px-6 md:py-2  rounded-xl font-bold relative" onClick={() => setDepositOpen(true)}>
          <span className="relative z-10">Deposit</span>
          <span className="absolute inset-0 bg-white opacity-10 rounded-xl pointer-events-none"></span>
        </button>
