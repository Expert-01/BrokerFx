...
export default function Hero() {  
  ...
  return (  
    <>  
      ...
      <section  
        className="relative flex flex-col items-center justify-center min-h-[600px] md:min-h-[800px] w-full overflow-hidden text-center px-4 bg-gradient-to-b from-[#2a1b0a] via-[#3b2a15] to-black"  
        data-aos="fade-up"  
      >  
        {/* Headline & Subtitle */}  
        <div  
